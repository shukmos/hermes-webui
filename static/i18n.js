...
const LOCALES = {
  ...
  cmd_close:'Mark this session as closed (adds ✓ to title)',
  cmd_close_done:'Session closed',
  cmd_close_already:'Session is already marked as closed',
  ...
  cmd_close:'セッションをクローズ (タイトルに ✓ を追加)',
  cmd_close_done:'セッションをクローズしました',
  cmd_close_already:'このセッションはすでにクローズ済みです',
